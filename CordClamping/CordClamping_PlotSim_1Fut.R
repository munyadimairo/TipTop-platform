###############################################################################
# task              : plots simulation results for the cord clamping research question with one interim analysis
# code dependencies :: cordclamping_1fut.R
...
#load simulation data produced by cordclamping_1fut.R
