################################################################################
# Author        : Munya Dimairo (Sheffield CTRU) (mdimairo@gmail.com/m.dimairo@sheffield.c.uk)
...
output<- input.par <- expand.grid(
            t1 = c(0.40, 0.45, 0.50, 0.55),    # 40% to 55% information fraction
...
for(i in 1:dim(output)[1]) {
   ...
   # futility stopping probability at stage 1
...
# save simulation results for data visualization tasks in "cord_clamping_plot_sim_1fut.R"
